  ...
  const capabilities = [
    {
      ...
      icon: <Layout className="text-white/80" size={28} />,
    ...
    {
      title: 'Backend & APIs',
      icon: <Server className="text-white/80" size={28} />,
    ...
    },
    {
      ...
      icon: <Settings className="text-white/80" size={28} />,
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
        {capabilities.map((cap, idx) => (
          <motion.div
            ...
            className="p-8 rounded-3xl glass-card flex flex-col gap-6 hover:border-white/10 transition-all duration-300 relative group overflow-hidden"
          >
            <div className="absolute top-0 right-0 w-[180px] h-[180px] bg-gradient-to-bl from-white/3 to-transparent rounded-full blur-[40px] pointer-events-none" />
            
            {/* Icon Wrapper */}
            <div className="p-4 bg-white/3 w-fit rounded-2xl border border-white/5 group-hover:bg-white/5 group-hover:border-white/10 transition-colors duration-300">
              {cap.icon}
            </div>
