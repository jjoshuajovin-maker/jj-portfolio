  ...
  const capabilities = [
    {
      ...
      icon: <Layout className="text-[#00B4D8]" size={28} />,
    ...
    },
    {
      ...
      icon: <Settings className="text-[#00B4D8]" size={28} />,
    ...
    <section id="capabilities" className="py-24 px-6 md:px-16 max-w-7xl mx-auto">
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
        {capabilities.map((cap, idx) => (
          ...
          >
            <div className="absolute top-0 right-0 w-[180px] h-[180px] bg-gradient-to-bl from-white/5 to-transparent rounded-full blur-[40px] pointer-events-none" />
            
            {/* Icon Wrapper */}
            <div className="p-4 bg-white/5 w-fit rounded-2xl border border-white/5 group-hover:bg-[#00B4D8]/10 group-hover:border-[#00B4D8]/20 transition-colors duration-300">
              {cap.icon}
            </div>
