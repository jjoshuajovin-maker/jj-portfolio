...
const Hero: React.FC = () => {
  return (
    ...
    >
      ...
      <div className="absolute top-0 right-0 w-[500px] h-[500px] bg-gradient-to-bl from-cyan-500/10 to-blue-600/5 rounded-full blur-[120px] pointer-events-none animate-pulse-glow" />
      ...
      <div className="max-w-4xl z-10 text-left">
        ...
        >
          <div className="h-16 w-16 rounded-2xl bg-[#1C2541] border border-white/10 flex items-center justify-center relative shadow-xl shadow-black/40 text-[#00B4D8] hover:text-white transition-colors duration-300">
            <Logo size={40} />
          </div>
        </motionElement.div>
        ...
        <motionElement.div
          ...
          className="inline-flex items-center px-4 py-1.5 rounded-full bg-[#00B4D8]/10 border border-[#00B4D8]/20 text-[#00B4D8] text-xs font-bold uppercase tracking-wider mb-6"
        >
        ...
        >
          <div className="flex items-center gap-2 px-5 py-3 rounded-xl bg-[#1C2541]/50 border border-white/5 text-secondary-text hover:text-text hover:border-white/10 transition-all duration-300">
            <span className="text-[#00B4D8] font-mono text-sm">&lt;/&gt;</span>
