    ...
    <section id="practices" className="py-24 px-6 md:px-16 max-w-7xl mx-auto">
      ...
      <div className="flex flex-col gap-6">
        {practices.map((practice, idx) => (
          ...
          >
            {/* Icon Wrapper */}
            <div className="p-3 bg-white/5 rounded-xl border border-white/5 group-hover:bg-[#00B4D8]/10 group-hover:border-[#00B4D8]/20 transition-all duration-300 flex-shrink-0">
              {practice.icon}
            </div>
