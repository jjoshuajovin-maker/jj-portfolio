    ...
    <section id="connect" className="py-24 px-6 md:px-16 max-w-7xl mx-auto relative overflow-hidden">
      ...
      <div className="flex flex-col items-center text-center max-w-3xl mx-auto gap-8 mb-16">
        ...
        <motion.div
          ...
          className="inline-flex items-center px-4 py-1.5 rounded-full bg-[#00B4D8]/10 border border-[#00B4D8]/20 text-[#00B4D8] text-xs font-bold uppercase tracking-wider"
        >
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-6 max-w-5xl mx-auto">
        ...
        <motion.a
          ...
          className="flex items-center gap-4 p-6 rounded-2xl bg-[#1C2541]/40 border border-white/5 hover:border-[#00B4D8]/20 transition-all duration-300 group"
        >
          <div className="p-3 bg-[#00B4D8]/10 rounded-xl text-[#00B4D8] group-hover:scale-110 transition-transform">
            <Mail size={22} />
          </div>
        ...
        <motion.a
          ...
          className="flex items-center gap-4 p-6 rounded-2xl bg-[#1C2541]/40 border border-white/5 hover:border-[#00B4D8]/20 transition-all duration-300 group"
        >
          <div className="p-3 bg-[#00B4D8]/10 rounded-xl text-[#00B4D8] group-hover:scale-110 transition-transform flex items-center justify-center">
