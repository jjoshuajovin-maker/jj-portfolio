  ...
  return (
    <section id="timeline" className="py-24 px-6 md:px-16 max-w-7xl mx-auto overflow-hidden">
      ...
      <div className="relative flex flex-col md:flex-row items-stretch md:items-start justify-between gap-8 md:gap-4 py-8">
        ...
        {/* Connection Line */}
        <div className="absolute top-1/2 left-[15px] md:left-0 md:top-[38px] w-[2px] md:w-full h-full md:h-[2px] bg-gradient-to-b md:bg-gradient-to-r from-blue-500 via-[#00B4D8] to-cyan-500/20 -z-10" />
        ...
        {steps.map((step, idx) => (
          ...
          >
            {/* Timeline Node Dot */}
            <div className="relative flex items-center justify-center w-8 h-8 rounded-full bg-[#0B132B] border-4 border-[#00B4D8] shadow-[0_0_15px_rgba(0,180,216,0.5)] z-10 flex-shrink-0">
